...
fun HttpRequest.logString(block: (String) -> Unit) {
...
fun HttpRequest.logString(block: StringTransformLog) {
 ...
 * 拦截字符串，返回新的字符串
 */
fun HttpRequest.hookString(block: (String) -> String) {
 ...
 * 拦截字符串，返回新的字符串
 */
fun HttpRequest.hookString(block: StringTransformLog) {
